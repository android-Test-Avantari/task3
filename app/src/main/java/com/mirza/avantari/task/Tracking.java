...
public class Tracking extends AccessibilityService {
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        Toast.makeText(getBaseContext(), ""+String.format(
                ...
                event.getEventTime(), getEventText(event)),Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onInterrupt() {
        Toast.makeText(getBaseContext(), "onInterrupt", Toast.LENGTH_LONG).show();
    }
